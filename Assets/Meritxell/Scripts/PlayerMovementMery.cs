...
public class PlayerMovementMery : MonoBehaviour
{
    ...
    private AnimationPlayerMery am;     // Aquí se referencia el script Animation PlayerMery
    ...
    private void Update()
    {
        ...
        {
            am = FindObjectOfType<AnimationPlayerMery>();            // Se busca el objeto que tenga el script 'AnimationManager' y se guarda en la variable 'am'
